...
//     // try {
//     //   const response = await axios.post("http://localhost:5959/api/predict", {
//     //     last_char: inputValue,
//     //   });

//     //   // Access the response data directly from response.data
...
//     // try {
//     //   const response = await axios.post("http://localhost:5959/api/train", {
//     //     sequence: message,
//     //   });
...
//     try {
//       const response = await axios.post("http://localhost:3000/api/train", {
//         sequence: message,
//       });
...
const GamePage = ({ params }: { params: Promise<{ id: string }> }) => {
  ...
  const handleFormat = () => {
    const formattedMessage = message.replace(/[^AB]/gi, ""); 
    setMessage(formattedMessage);
  };
